...
class ContextualLoss(nn.Module):
    ...
    def __init__(self):
        ...
        return None
    ## 修改带宽参数h为更小的值(增强细节敏感度)
    def forward(self, X_features, Y_features, h=0.15, feature_centering=True):
        '''
...
class ContextualLoss_complex(nn.Module):
    ...
    def __init__(self):
        ...
        return None
    # 使用更小的patch_size捕获更精细的结构
    def forward(self, X_features, Y_features, h=0.15, patch_size=1, direction='forward'):
        '''
        X_features&Y_features are are feature vectors or feature 2d array
        h: bandwidth
        return the per-sample loss
